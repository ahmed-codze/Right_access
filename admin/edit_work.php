...
if (isset($_GET['id'])) {
    ...
    foreach ($rows as $row) {
        $client = $row['client'];
        $en_client = $row['en_client'];
        $link = $row['link'];
        $description = $row['description'];
        $en_description = $row['en_description'];
        $catagory = $row['catagory'];
        $en_catagory = $row['en_catagory'];
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 text-end" dir="rtl">
                <form action="edit_work.php?id=<?php echo $_GET['id'] ?>" method="POST" class="form-group" style="margin: 20px;" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" list="catagory" class="form-control" name="catagory" value="<?Php echo $catagory; ?>" />
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" list="en_catagory" class="form-control" name="en_catagory" value="<?Php echo $en_catagory; ?>" />
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" class="form-control" id="en_client" name="en_client" value="<?Php echo $en_client; ?>">
                        </div>
                        <div class="col-md-6">
                            <label for="description">وصف العمل</label>
                            <br>
                            <textarea class="form-control" id="description" name="description" style="height: 200px;"><?Php echo $description; ?></textarea>
                        </div>
                        <div class="col-md-6">
                            <label for="en_description">description</label>
                            <br>
                            <textarea class="form-control" id="description" name="en_description" style="height: 200px;"><?Php echo $en_description; ?></textarea>
                        </div>
                        <div class="col-12 text-center">
                            <button class="btn btn-primary w-50" type="submit">تحديث</button>
                        </div>
                    </div>
                </form>
            </main>
